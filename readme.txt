This is solution for term paper "Two factor authetification for Windows 7" for Operating Systems Secutiry course. Project consists of one GUI application (Credential manager) and one DLL (USBCredentialProvider).
