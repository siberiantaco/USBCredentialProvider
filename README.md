...
This one is GUI which implements convinient way to create key-files for any user and add digest values to Windows Registry. C++ Builder XE5 Project. See **Unit4.cpp**.
____________________________________
